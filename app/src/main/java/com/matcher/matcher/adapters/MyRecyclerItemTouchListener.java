...
import com.matcher.matcher.dialogs.InviteFriendsDialog;
...
public class MyRecyclerItemTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    public MyRecyclerItemTouchListener(InviteFriendsDialog context, final RecyclerView recyclerView, OnItemClickListener listener) {
        mListener = listener;
